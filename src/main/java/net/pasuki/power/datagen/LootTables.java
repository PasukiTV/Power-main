...
import net.pasuki.power.blocks.SolarCellBlockEntity;
...
public class LootTables extends VanillaBlockLoot {
    ...
    protected void generate() {
        ...
        createStandardTable(Registration.SOLARCELL_BLOCK.get(), Registration.SOLARCELL_BLOCK_ENTITY.get(), SolarCellBlockEntity.ENERGY_TAG);
