package net.pasuki.power.cables.client;

import net.pasuki.power.Power;
import net.pasuki.power.cables.ConnectorType;
import net.pasuki.power.cables.blocks.CableBlock;
import net.pasuki.power.cables.client.CablePatterns.Pattern;
import net.pasuki.power.cables.client.CablePatterns.QuadSetting;
...
import static net.pasuki.power.cables.ConnectorType.*;
import static net.pasuki.power.cables.client.CablePatterns.SpriteIdx.*;
import static net.pasuki.power.tools.BakedModelHelper.quad;
import static net.pasuki.power.tools.BakedModelHelper.v;
...
public class CableBakedModel implements IDynamicBakedModel {
    ...
    private TextureAtlasSprite getTexture(String path) {
        return Minecraft.getInstance().getTextureAtlas(InventoryMenu.BLOCK_ATLAS).apply(new ResourceLocation(Power.MODID, path));
    }
